...
public class DiskUtils {
	 ...
	 * amount of IOOperations. 
	 * 
	 * @param source The source folder on the Phone's/Tablet's local storage.
	 * @param targetPath Relative path on the connected external USB device.
	 */
	public static void rsync(File source, String targetPath) throws IOException {
		
	}
	
	private static void copy(List<Pair<File, File>> filesToCopy) throws IOException {
